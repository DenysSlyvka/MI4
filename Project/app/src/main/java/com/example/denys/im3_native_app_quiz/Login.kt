...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnMakeAccount : Button = findViewById(R.id.btn_register_account)
        btnMakeAccount.setOnClickListener{
            val intent = Intent(this, make_account :: class.java)
    ...
    private fun initialise() {
        ...
        tvForgotPassword!!.setOnClickListener { startActivity(Intent(this@Login, ForgotPasswordActivity::class.java)) }
        btnCreateAccount!!
            .setOnClickListener { startActivity(Intent(this@Login,
                make_account::class.java)) }
